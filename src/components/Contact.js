    ...
    <section id="contact" className="contact-section">
      <div className="container">
        ...
        <div className="section-header reveal slide-up" ref={headerRef} style={{ textAlign: 'center', marginBottom: '60px', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <h2 className="section-title" style={{ textAlign: 'center' }}>Let's <span className="gradient-text" style={{background: 'linear-gradient(135deg, var(--accent-green), var(--accent-cyan))', WebkitBackgroundClip: 'text'}}>Connect</span></h2>
          <p className="section-subtitle" style={{ margin: '0 auto', textAlign: 'center', color: 'var(--text-secondary)' }}>
